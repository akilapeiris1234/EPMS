...
const vehicleTypes = ["Van", "Truck", "Motorcycle", "Car", "Bus", "Pickup", "Lorry"];

// Sample Data from the image
const incomingPackages = [
  { trackingNumber: "000001", type: "Incoming", customer: "Vision care panadura", employee: "Mr.onel", status: "Pending", date: "3.18.2026", time: "1.26 PM", mode: "single" },
  { trackingNumber: "000002", type: "Incoming", customer: "Vision care panadura", employee: "Mr.onel", status: "collected", date: "3.18.2026", time: "1.26 PM", mode: "batch" },
  { trackingNumber: "000003", type: "Incoming", customer: "Vision care panadura", employee: "Mr.onel", status: "collected", date: "3.18.2026", time: "1.26 PM", mode: "single" },
  { trackingNumber: "000004", type: "Incoming", customer: "Vision care panadura", employee: "Mr.onel", status: "Pending", date: "3.18.2026", time: "1.26 PM", mode: "batch" },
  { trackingNumber: "000005", type: "Incoming", customer: "Vision care panadura", employee: "Mr.onel", status: "Pending", date: "3.18.2026", time: "1.26 PM", mode: "single" },
  { trackingNumber: "000006", type: "Incoming", customer: "Vision care panadura", employee: "Mr.onel", status: "Pending", date: "3.18.2026", time: "1.26 PM", mode: "batch" },
  { trackingNumber: "000007", type: "Incoming", customer: "Vision care panadura", employee: "Mr.onel", status: "Pending", date: "3.18.2026", time: "1.26 PM", mode: "single" }
];

export default function IncomingPackagePage() {
  const [searchQuery, setSearchQuery] = useState("");
  const { goToIncomingVerification } = useNavigation();
  const { currentPage, setCurrentPage, paginatedItems: paginatedPackages, totalPages, totalItems: totalIncomingPackages } = usePagination({ items: incomingPackages, itemsPerPage: 10 });
            ...
            >
              ...
              >
                ...
                <div className="col-span-1 flex justify-end">
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                      goToIncomingVerification(pkg.trackingNumber);
                    }}
              ...
              >
                <div className="flex justify-between items-center border-b border-gray-50 pb-3">
                  <span className="font-black text-[#0c244c] tracking-tighter">#{pkg.trackingNumber}</span>
